...
{{-- Mobile drawer --}}
<div id="admin-nav-drawer" class="fixed inset-0 z-50 hidden lg:hidden" aria-hidden="true" role="dialog" aria-modal="true" aria-label="{{ __('admin.nav.menu') }}">
    <div class="fixed inset-0 bg-black/50" data-mobile-nav-close aria-hidden="true"></div>
    <aside data-mobile-nav-panel class="fixed inset-y-0 left-0 flex w-[min(100%,18rem)] flex-col bg-[#003366] text-white shadow-xl">
